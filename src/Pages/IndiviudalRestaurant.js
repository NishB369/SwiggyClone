  ...
  return (
    <>
      ...
      {isLoading ? (
        ...
        <div className="px-60 py-10 pb-0">
          <div
            className={`fixed h-[425px] w-[575px] bg-black rounded-xl shadow-xl z-10 text-gray-200 bottom-10 right-80 px-8 py-8 text-lg flex-col overflow-y-scroll gap-3 ${
              menuBtn ? "flex" : "hidden"
            }`}
          >
